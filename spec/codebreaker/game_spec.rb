...
module Codebreaker
  describe Game do
    ...
    context 'marking a guess' do
      context 'with all four colors correct and in the correct positions' do
      ...
      context 'with all four colors correct and two in the correct positions' do
      ...
      context 'with all four colors correct and one in the correct position' do
      ...
      context 'with three colors in the correct positions' do
